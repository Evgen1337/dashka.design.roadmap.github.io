...
# Сеточные системы (Гриды).
  ``_Что гриды собой представляют и как их можно применить в процессе проектирования._``
  - [Ссылка из статьи - eng](https://www.smashingmagazine.com/2017/12/building-better-ui-designs-layout-grids/)

# Цвет.
  _Большая серия из трех частей по теории цвета - Значение цвета, понимание концепции и создаем собственную цветовую схему._
