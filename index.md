...
В конце сайта будет таблица с линком на некоторые источники и вообще типо некой библиотеки.
...
В идеале нужно (можно) идти по порядку. Также в доп. материалах можно найти доп. ссылки и книги__
...
- [Программы для веб-дизайнера - ru](https://www.surgebook.com/egorkomarov/book/osnovi_web_dizaina/programmy-dlya-veb-dizainera)

### Сеточные системы (Гриды).
  ``Что гриды собой представляют и как их можно применить в процессе проектирования. В статье досточно много инфы, а также линки на полезные инструменты.``
  - [Сетка (Grid system) - ru](https://www.surgebook.com/egorkomarov/book/osnovi_web_dizaina/setka-grid-system)

### Цвет.
  ``Большая серия из трех частей по теории цвета - Значение цвета, понимание концепции и создаем собственную цветовую схему.``
  - [Крутая статья о работе с цветом ч.1 - ru](https://www.surgebook.com/egorkomarov/book/osnovi_web_dizaina/rabota-s-cvetom)
  - [Крутая статья о работе с цветом ч.2 - ru](https://www.surgebook.com/egorkomarov/book/osnovi_web_dizaina/rabota-s-cvetom-2-chast)
...
### Типографика.
 ``Очень важная тема по графическому оформлению печатного текста.``
 - [Работа со шрифтами. Содержит полезные ресурсы по оттачиванию навыков - ru](https://www.surgebook.com/egorkomarov/book/osnovi_web_dizaina/rabota-so-shriftami)
 - [Маст хев для чтения книга. "О шрифте". Эрик Шпикерманн - ru](https://vk.com/doc-75576143_536563285?hash=7738993be4ba82f21b&dl=7ce110a16c21558cbf)
...
# РАЗДЕЛ ЕЩЕ НЕ ГОТОВ И МОЖНО ЕГО НЕ ЧИТАТЬ (!!!!!!!!!!!!!!!!!!!!!!!)
...
<td markdown="span">За основу брал этот сайт - тут все самое, что чаще всего везде пишут. На Английском (!!!)</td>
</tr>
<tr>
...
<tr>
<td markdown="span">[Библиотека фри книг](https://vk.com/topic-75576143_34845915)</td>
<td markdown="span">Просто стопка фри пдфников</td>
</tr>
<tr>
